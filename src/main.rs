    ...
    app
        ...
        .add_system_set(
            SystemSet::on_update(GameState::Play)
                ...
                .with_system(resources::Reality::system_camera_updater.label("ui").after("player").after("cursor"))
                ...
                .with_system(resources::Reality::system_chunk_derenderer.after("calls unrender").before("renders chunks"))
                ...
                .with_system(resources::Reality::system_display_blueprint.after("player").before("ui"))
